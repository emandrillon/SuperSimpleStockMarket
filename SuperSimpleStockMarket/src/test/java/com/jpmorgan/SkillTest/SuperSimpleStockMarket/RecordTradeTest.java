...
public class RecordTradeTest {
	...
	public void Record1Trade() {
		...
		tradeList = tradeRecorder.getTrades();

		assertTrue(tradeList.contains(trade));
	}

	@Test
	public void Record5Trade() {
		ArrayList<Trade> tradeList;
		...
		assertTrue(tradeList.contains(trade1));
		assertTrue(tradeList.contains(trade2));
		assertTrue(tradeList.contains(trade3));
		assertTrue(tradeList.contains(trade4));
		assertTrue(tradeList.contains(trade5));
